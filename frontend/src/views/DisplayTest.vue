<!-- frontend/src/views/DisplayTest.vue -->
<template>
  <div class="page display-test-v3">
    <!-- Header -->
    <div class="header-bar">
      <div class="left">
        <h2 class="title">📄 Display Test Report</h2>
        ...
        <el-tag effect="plain" style="margin-left: 8px">
          {{ draft.cover.reportName || 'Display Test Report' }} · Rev
          ...
          <div class="pane">
            ...
            <div class="grid2">
              ...
              <div class="field wide">
                ...
                <el-input v-model="draft.cover.reportName" placeholder="Display Test Report" />
              </div>
        ...
        <el-tab-pane name="config" label="Config">
          <div class="pane">
            ...
            <div class="cfg">
              ...
              <div class="cfg-row">
                <div class="cfg-label">1.2 Main Board / Signal Source List</div>
                <div class="cfg-controls">
                  <div class="cfg-sheet-title"><b>Main Board / Signal Source List</b></div>
                  <div class="hint">In below table, it lists main boards / signal sources that DUT will be tested with.</div>
              ...
              <div class="cfg-row">
                <div class="cfg-label">1.3 Input Source / Test System List</div>
                <div class="cfg-controls">
                  <div class="cfg-sheet-title"><b>Input Source / Test System List</b></div>
                  <div class="hint">In below table, it lists input sources / systems that DUT will be tested with.</div>
                  <div class="row-actions">
              ...
              <div class="cfg-row">
                <div class="cfg-label">#.# Panel Accessory List</div>
                <div class="cfg-controls">
                  <div class="cfg-sheet-title"><b>Panel Accessory List</b></div>
                  <div class="row-actions">
              ...
              <div class="cfg-row">
                <div class="cfg-label">1.4 Appearance of Display</div>
                <div class="cfg-controls">
                  <div class="cfg-sheet-title"><b>Appearance of Display</b></div>
                  <div class="grid2eq">
...
/* ---------------- kind ---------------- */
const REPORT_KIND = 'display'
const kind = ref(REPORT_KIND)

const knownKinds = ref([REPORT_KIND])

function loadKnownKinds () {
  return [REPORT_KIND]
}
function persistKnownKinds () {}
function ensureKnownKind () {}
...
function makeDisplayTemplate () {
  return {
    cover: {
      projectName: '',
      reportName: 'Display Test Report',
      revision: '0.1',
    ...
    configSheet: {
      ...
      appearance: {
        topCaption: 'FRONT VIEW',
        topPhotos: [],
        bottomCaption: 'REAR VIEW',
        bottomPhotos: [],
      },
    },
    enabled: {
    ...
    sections: [
      {
        ...
        intro: 'Verify display can power on, switch input, and operate OSD normally.',
        testCases: [
          { code: 'BF_001', title: 'Power On / OSD Test', estHrs: 0.5, procedure: 'Power on DUT, check panel lighting and OSD menu operation.', criteria: 'Display powers on normally and OSD functions correctly.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'BF_002', title: 'Input Source Switching', estHrs: 0.5, procedure: 'Switch through supported input sources and verify signal detection.', criteria: 'All supported input sources can be switched and displayed correctly.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'BF_003', title: 'Panel Defect Inspection', estHrs: 0.5, procedure: 'Inspect panel for dead pixel / mura / scratch / cosmetic defect under standard condition.', criteria: 'Panel appearance meets acceptance criteria.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
        ],
      },
      {
        key: 'quality',
        ...
        intro: 'Validate image performance including brightness, contrast, color and viewing angle.',
        testCases: [
          { code: 'DQ_001', title: 'Brightness Test', estHrs: 0.5, procedure: 'Measure panel brightness at defined test pattern and setting.', criteria: 'Brightness meets target specification.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'DQ_002', title: 'Contrast Test', estHrs: 0.5, procedure: 'Measure contrast under standard pattern and environment.', criteria: 'Contrast ratio meets target specification.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'DQ_003', title: 'Color / White Balance Test', estHrs: 0.5, procedure: 'Measure color performance and white balance with color meter.', criteria: 'Color performance is within defined acceptance range.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'DQ_004', title: 'Viewing Angle Test', estHrs: 0.5, procedure: 'Observe and record display quality from defined viewing angles.', criteria: 'Viewing angle result meets product requirement.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
        ],
      },
      {
        key: 'touch',
        ...
        intro: 'Verify touch function if DUT supports touch interface.',
        testCases: [
          { code: 'TP_001', title: 'Touch Function Test', estHrs: 0.5, procedure: 'Check single touch response across active area.', criteria: 'Touch response is correct and stable across screen area.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'TP_002', title: 'Multi-touch Test', estHrs: 0.5, procedure: 'Perform multi-touch gesture / point tracking test.', criteria: 'Multi-touch function behaves normally according to specification.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
        ],
      },
      {
        key: 'interface',
        ...
        intro: 'Check HDMI / DP / VGA / USB / Audio or other supported ports.',
        testCases: [
          { code: 'IF_001', title: 'Video Input Interface Test', estHrs: 0.5, procedure: 'Verify each supported video interface with valid source.', criteria: 'Each supported video interface works normally.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'IF_002', title: 'USB / Audio Interface Test', estHrs: 0.5, procedure: 'Verify supported USB / audio related ports and functions.', criteria: 'USB / audio related interface works normally.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
        ],
      },
      {
        key: 'reliability',
        ...
        intro: 'Check long-hour operation stability and repeated power behavior.',
        testCases: [
          { code: 'RE_001', title: 'Burn-in Test', estHrs: 8, procedure: 'Run display under defined pattern and environment for required duration.', criteria: 'No abnormal image / hang / restart during burn-in.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 8 }] },
          { code: 'RE_002', title: 'Power Cycle Test', estHrs: 1, procedure: 'Perform repeated power cycle and verify display recovery.', criteria: 'Display can recover normally through required cycle count.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 1 }] },
        ],
      },
    ],
  }
...
const BUILTIN_TEMPLATES = {
  [REPORT_KIND]: makeDisplayTemplate,
  generic: makeDisplayTemplate,
}
...
function buildPdfHtml (pdfAssets = {}) {
  ...
  pushPage(`
    ...
    <div class="toc-list">
      ...
      <div class="toc-item toc-sub"><span>1.2 Main Board / Signal Source List</span><span></span></div>
      <div class="toc-item toc-sub"><span>1.3 Input Source / Test System List</span><span></span></div>
      <div class="toc-item toc-sub"><span>1.4 Appearance of Display</span><span></span></div>
      ${enabled.map(sec => `
  ...
  pushPage(`
    ...
    <div class="table-note">In below table, it lists main boards / signal sources that DUT will be tested with.</div>
    <table class="report-table">
      <thead>
        <tr>
    ...
    <div class="table-note">In below table, it lists input sources / systems that DUT will be tested with.</div>
    <table class="report-table">
      <thead>
        <tr>
          <th class="green-head pn-col">P/N</th>
...
async function exportPdf () {
  try {
    ...
    const res = await fetch(`${apiBase}/report/display-test/${id}/pdf`, {
      method: 'POST',
      headers: {
        ...authHeaders(),
...
function onKindChanged (v) {
  ...
  router.replace({ query: { ...route.query, page: 'config' } }).catch(() => {})
  loadDraft()
}
function tryLoadTemplateByKind () {
  ...
  ElMessage.success('已載入 Display 預設模板')
}
