<!-- frontend/src/views/ArmTest.vue -->
<template>
  <div class="page arm-test-v3">
    <!-- Header -->
    <div class="header-bar">
      <div class="left">
        <h2 class="title">📄 ARM Test Report</h2>
        ...
        <el-tag effect="plain" style="margin-left: 8px">
          {{ draft.cover.reportName || 'ARM Test Report' }} · Rev
          ...
          <div class="pane">
            ...
            <div class="grid2">
              ...
              <div class="field wide">
                ...
                <el-input v-model="draft.cover.reportName" placeholder="ARM Test Report" />
              </div>
        ...
        <el-tab-pane name="config" label="Config">
          <div class="pane">
            ...
            <div class="cfg">
              ...
              <div class="cfg-row">
                <div class="cfg-label">1.2 CPU / SBC Board List</div>
                <div class="cfg-controls">
                  <div class="cfg-sheet-title"><b>CPU / SBC Board List</b></div>
              ...
              <div class="cfg-row">
                <div class="cfg-label">1.3 Carrier / System List</div>
                <div class="cfg-controls">
                  <div class="cfg-sheet-title"><b>Carrier / System List</b></div>
                  <div class="hint">In below table, it lists carrier boards / systems that DUT will be tested with.</div>
                  <div class="row-actions">
              ...
              <div class="cfg-row">
                <div class="cfg-label">#.# Peripheral / Accessory List</div>
                <div class="cfg-controls">
                  <div class="cfg-sheet-title"><b>Peripheral / Accessory List</b></div>
                  <div class="row-actions">
...
function makeArmTemplate () {
  return {
    cover: {
      projectName: '',
      reportName: 'ARM Test Report',
      revision: '0.1',
    ...
    sections: [
      {
        ...
        intro: 'Verify ARM platform can power on, boot to OS, and detect key peripherals normally.',
        testCases: [
          { code: 'DI_001', title: 'Power On Test', estHrs: 0.5, procedure: `Connect required power source and accessories.
Power on DUT and observe LED / power behavior.`, criteria: 'System powers on normally without abnormal reset / hang.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'DI_002', title: 'Boot to OS', estHrs: 0.5, procedure: `Boot DUT into target OS / image.
Check boot flow and login readiness.`, criteria: 'System boots into OS successfully and is operable.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'DI_003', title: 'Peripheral Detection', estHrs: 0.5, procedure: 'Check Ethernet / USB / storage / display / audio / serial device enumeration.', criteria: 'Major peripherals are recognized correctly by OS / firmware.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
        ],
      },
      {
        key: 'function',
        no: '3.',
        title: 'Function Test',
        intro: 'Validate key interface and platform functions on ARM system.',
        testCases: [
          { code: 'FN_001', title: 'Ethernet Function', estHrs: 0.5, procedure: 'Connect LAN cable and run connectivity / throughput verification.', criteria: 'Ethernet port works normally without packet loss in basic verification.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'FN_002', title: 'USB Function', estHrs: 0.5, procedure: 'Connect USB devices and verify read/write / detection behavior.', criteria: 'USB ports detect devices correctly and function normally.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'FN_003', title: 'Audio Function', estHrs: 0.5, procedure: 'Verify audio input / output path with headset or speaker.', criteria: 'Audio playback / record works normally.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
          { code: 'FN_004', title: 'UART / CAN / GPIO Function', estHrs: 1, procedure: 'Verify board-specific interfaces such as UART / CAN / GPIO according to product requirement.', criteria: 'Board-specific interfaces meet expected basic function.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 1 }] },
        ],
      },
      {
        key: 'performance',
        ...
        intro: 'Measure basic CPU / memory / storage loading capability of ARM platform.',
        testCases: [
          { code: 'PF_001', title: 'CPU Stress Test', estHrs: 1, procedure: 'Run CPU loading tool / benchmark under full load for defined duration.', criteria: 'CPU stress completes without crash / throttling anomaly beyond expectation.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 1 }] },
          { code: 'PF_002', title: 'Memory Stress Test', estHrs: 1, procedure: 'Run memory stress / allocation test for defined duration.', criteria: 'Memory stress completes without error.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 1 }] },
          { code: 'PF_003', title: 'Storage Benchmark', estHrs: 0.5, procedure: 'Run sequential / random read-write benchmark on system storage.', criteria: 'Storage benchmark result is within expected range and no abnormal error occurs.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 0.5 }] },
        ],
      },
      {
        key: 'reliability',
        ...
        intro: 'Check continuous operation and repeated restart reliability.',
        testCases: [
          { code: 'RE_001', title: 'Burn-in Test', estHrs: 8, procedure: 'Run platform under defined loading / aging condition for required duration.', criteria: 'No crash / hang / unexpected reboot during burn-in period.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 8 }] },
          { code: 'RE_002', title: 'Reboot Cycle Test', estHrs: 1, procedure: 'Perform repeated reboot / power cycle according to validation plan.', criteria: 'System completes required cycles without failure.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 1 }] },
        ],
      },
      {
        key: 'thermal',
        ...
        intro: 'Record platform temperature under idle / load condition.',
        testCases: [
          { code: 'TH_001', title: 'Full Load Thermal Test', estHrs: 1, procedure: 'Run full load tool and record CPU / board temperature in steady state.', criteria: 'Thermal performance is within design expectation and system remains stable.', photos: [], note: '', records: [{ remark: '', result: 'UNTESTED', hours: 1 }] },
        ],
      },
    ],
  }
...
const BUILTIN_TEMPLATES = {
  [REPORT_KIND]: makeArmTemplate,
  generic: makeArmTemplate,
}
...
function buildPdfHtml (pdfAssets = {}) {
  ...
  pushPage(`
    ...
    <div class="toc-list">
      ...
      <div class="toc-item toc-sub"><span>1.2 CPU / SBC Board List</span><span></span></div>
      <div class="toc-item toc-sub"><span>1.3 Carrier / System List</span><span></span></div>
  ...
  pushPage(`
    ...
    <div class="table-note">In below table, it lists carrier boards / systems that DUT will be tested with.</div>
    <table class="report-table">
      <thead>
        <tr>
          <th class="green-head pn-col">P/N</th>
...
async function exportPdf () {
  try {
    ...
    const res = await fetch(`${apiBase}/report/arm-test/${id}/pdf`, {
      method: 'POST',
      headers: {
        ...authHeaders(),
...
function tryLoadTemplateByKind () {
  ...
  ElMessage.success('已載入 ARM 預設模板')
}
